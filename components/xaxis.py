...
class XAxis(Common):
    """
    Represents the X-axis of the chart, allowing for detailed customization
    ...
    _valid_attributes = [
        ...
        'linkedTo', 'margin', 'max', 'maxPadding', 'maxZoom', 'min', 'minorGridLineColor', 
        ...
        'plotBands', 'plotLines', 'reversed', 'reversedStacks', 'showEmpty', 'showFirstLabel', 
        'showLastLabel', 'softMax', 'softMin', 'startOfWeek', 'startOnTick', 'tickAmount', 
        'tickColor', 'tickInterval', 'tickLength', 'tickmarkPlacement', 'tickPixelInterval', 
        'tickPosition', 'tickPositioner', 'tickPositions', 'tickWidth', 'title', 'top', 'type', 
        'uniqueNames', 'units', 'visible', 'width', 'zIndex', 'zoomEnabled'
    ]
    
    def __init__(self, **kwargs):
        """
        Initialize the XAxis options with given keyword arguments.
